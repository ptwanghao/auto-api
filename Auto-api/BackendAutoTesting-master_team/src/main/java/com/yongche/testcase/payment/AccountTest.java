...
public class AccountTest {
    ...
    private static String s_accountId = null;

    /**
     * Read payment account id from config file
     * @return
     */
    private static synchronized String getAccountId(){
        if (null == s_accountId ) {
            s_accountId = ConfigUtil.getValue(ConfigConst.RIDER_INFO,"payment_account_id");
        }
