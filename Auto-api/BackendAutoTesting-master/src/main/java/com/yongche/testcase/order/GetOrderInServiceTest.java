...
public class GetOrderInServiceTest {
    ...
    public void getOrderInService_Should_Success_With_Valid_Parameters() throws Exception{
        //新创建订单 生成订单号
        TestParameter order_id = Order.createOrderByProductTypeId(ParamValue.PRODUCT_TYPE_ID_IMMEDIATE);
        ...
        //查询司机当前服务的订单
        Map<String,TestParameter> inputParameterMap = MapUtil.getParameterMap("driver_id",driver_id);
        Map<String,TestParameter> result = CaseExecutor.runTestCase("order_getOrderInService.xml",inputParameterMap);
