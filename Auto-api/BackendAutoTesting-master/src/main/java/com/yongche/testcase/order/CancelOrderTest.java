...
public class CancelOrderTest {
    ...
    public void order_cancelOrder_shouldSucceed_beforeServiceAndCancel(){
        ...
        //APP下单
        TestParameter source = TestParameter.getTestParameter("source", ParamValue.SOURCE_ANDROIDAPP);
        ...
        inputParameterMap.put("source",source);
    ...
    public void order_cancelOrder_shouldSucceed_beforeServiceAndCancelFromERP(){
        ...
        TestParameter is_auto_dispatch = TestParameter.getTestParameter("is_auto_dispatch", "1");
        //ERP下单
        TestParameter source = TestParameter.getTestParameter("source", ParamValue.SOURCE_ERP);
